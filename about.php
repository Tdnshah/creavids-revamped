    ...
    <main class="lg:py-24">
      <section>
        ...
        <div class="w-full mx-auto">
          <p
            class="text-2xl text-center italic font-semibold text-gray-600 tracking-wider"
          >
      ...
      <section>
        <div class="w-1/2 mx-auto my-10">
          <p
            class="text-xl text-justify font-semibold text-gray-600 tracking-wide"
          >
      ...
      <section>
        <div class="my-24 mx-64" id="overline">
        ...
        <div class="my-2 mx-20">
          <div
            class="py-2 px-1"
            style="background: linear-gradient(90deg, #41e1f2 0%, #AFE776 100%)"
          >
