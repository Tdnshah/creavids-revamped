        ...
        <div class="w-full py-6">
          <div class=" flex flex-wrap lg:px-16 py-6 text-center ">
            ...
            <div class="w-full py-6 lg:w-1/2 lg:pr-24">
              <a href="/contact" class="hover:text-creavidsGreen text-gray-500 text-base lg:text-3xl px-16 py-8 lg:px-32 lg:py-16 font-semibold uppercase " style="background-image: url('./Assets/buttons/button.png');background-size:contain;background-repeat:no-repeat;background-position: center;">Let's
                Talk</a>
