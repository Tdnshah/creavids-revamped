  ...
  <body class="antialiased bg-grey-200 overflow-x-hidden mx-auto">
    <main class="lg:py-20">
      <section class="bg-white py-10">
        ...
        <h1 class="py-2 px-64 text-center text-3xl font-semibold text-teal-400">
      ...
      <section class="mx-auto max-w-screenFullWidth">
        <div id="appexplore">
          <section>
            <div class="flex flex-wrap mx-auto p-10">
              <ul class="flex flex-wrap mx-auto justify-center">
                <li class="my-5" v-for="(catName , index) in this.catName">
                  <a
                    class="border-2 cursor-pointer border-teal-300 text-gray-800 mr-2 mt-5 px-4 py-2 font-bold uppercase hover:shadow-outline rounded-full"
                    :class="{ 'active' : index == active }"
                    v-on:click="filterVideos(catName, index)"
                    >{{ catName }}</a
                  >
                </li>
              </ul>
          ...
          <section>
            <div class="flex flex-wrap mx-auto p-10" id="videoShowCase">
              <div
                class="px-2 mb-5 w-4/12"
                v-if="filteredVideo.length == 0"
                v-for="(exploreVideo , index) in this.paginated"
              >
                <div class="h-56 bg-teal-200">
                  <iframe
                    class="w-full h-full"
                    :src="getId(exploreVideo.link)"
                    frameborder="0"
              ...
              <div
                class="px-2 mb-5 w-4/12"
                v-if="filteredVideo.length > 0"
                v-for="(exploreVideo , index) in this.filteredVideo"
              >
                <div class="h-56 bg-teal-200">
                  <iframe
                    class="w-full h-full"
            ...
            <div
              v-if="this.filteredVideo.length == 0"
      ...
      var app = new Vue({
        ...
        data: {
          exploreVideos: [
            ...
            {
              link:
                "https://www.youtube.com/watch?v=b6MSjnKHM_s&feature=youtu.be",
            ...
            {
              link:
                "https://www.youtube.com/watch?v=o-MHs8AuL4A&feature=youtu.be",
              catName: "Explainer Videos"
            },
            {
            ...
            {
              link:
                "https://www.youtube.com/watch?v=X7HNWwZo51Y&feature=youtu.be",
              catName: "3D Product Videos"
            },
            {
              link:
                "https://www.youtube.com/watch?v=ny3AGHM7uJo&feature=youtu.be",
              catName: "3D Product Videos"
            },
            {
              link:
                "https://www.youtube.com/watch?v=aafweu96Zgw&feature=youtu.be",
              catName: "Explainer Videos"
            },
            {
            ...
            {
              link:
                "https://www.youtube.com/watch?v=0lA1lanLLgk&feature=youtu.be",
              catName: "Explainer Videos"
            },
            {
            ...
            {
              link:
                "https://www.youtube.com/watch?v=DNpmNbOALuk&feature=youtu.be",
              catName: "3D Product Videos"
            },
            {
              link:
                "https://www.youtube.com/watch?v=_onneAgyDNI&feature=youtu.be",
            ...
            {
              link:
                "https://www.youtube.com/watch?v=Jz16kC1sCbg&feature=youtu.be",
              catName: "Explainer Videos"
            },
            {
              link:
                "https://www.youtube.com/watch?v=r3rcjAh5qro&feature=youtu.be",
              catName: "Explainer Videos"
            },
            {
              link:
                "https://www.youtube.com/watch?v=dchHehGDfkc&feature=youtu.be",
              catName: "Explainer Videos"
            },
            {
              link:
                "https://www.youtube.com/watch?v=p3I886tHw6I&feature=youtu.be",
              catName: "Explainer Videos"
            },
            {
              link:
                "https://www.youtube.com/watch?v=0ZUrvFV2_R4&feature=youtu.be",
              catName: "App Videos"
            },
            {
            ...
            {
              link:
                "https://www.youtube.com/watch?v=20wr6x4COmU&list=PLeDzLGmrDaawLuX21HRVSPHh851tNzhFb&index=5",
              catName: "Infographic Videos"
            },
            {
              link:
                "https://www.youtube.com/watch?v=jW4Fdm5nMro&list=PLeDzLGmrDaawLuX21HRVSPHh851tNzhFb&index=6",
              catName: "Infographic Videos"
            },
            {
              link:
                "https://www.youtube.com/watch?v=rSCPf2hmmc0&list=PLeDzLGmrDaawLuX21HRVSPHh851tNzhFb&index=11",
              catName: "Infographic Videos"
            },
            {
            ...
            {
              link:
                "https://www.youtube.com/watch?v=q9KitWvMsQI&feature=emb_logo",
              catName: "Infographic Videos"
            },
            {
