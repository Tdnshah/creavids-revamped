        ...
        <div class="p-6 lg:w-1/2 my-auto text-justify overflow-auto">
          <div class="w-full lg:pl-20 lg:pb-10">
            ...
            <p class="text-lg text-gray-600">
              If you are a Digital Agency, Marketing Company,
              Brand Consultant or even a video enthusiast who
              wants to add video production to your expertise,
              you should be interested. Creavids offers the
              smartest way to add value and increase your
              recurring revenue. At a fixed budget, we offer you
              end to end white-label solution that includes
            </p>
            <br>
          </div>
        </div>
        ...
        <div class="w-full py12 lg:py-6">
          <div data-aos="zoom-in" class="text-center lg:px-40">
            ...
            <div class="lg:m-6">
              ...
              <input type="text" class="py-4 px-2 my-4 w-full border-b-4 border-teal-400 font-hairline text-xl" name="more_info" placeholder="More Information" />
