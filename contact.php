      ...
      <div class="flex flex-wrap w-1/2">
        ...
        <div class="w-1/4 p-8 justify-center">
          <ul>
            ...
            <li class="flex my-2 text-xl text-creavidsTeal font-bold"><a class="flex" href="/about.html"><img src="./Assets/footer/About.svg" class="mr-2 -ml-2 -mt-2 h-10" alt=""> About</a></li>
            <li class="flex my-2 text-xl text-creavidsTeal font-bold"><a class="flex" href="/process.html"><img src="./Assets/footer/Process.svg" class="mr-4  -mt-1 -ml-2 w-8 h-10" alt="">Process</a></li>
            <li class="flex my-2 text-xl text-creavidsTeal font-bold"><a class="flex" href="/explore.html"><img src="./Assets/footer/Explore.svg" class="mr-4  -mt-2 -ml-2 w-8 h-10" alt="">Explore</a></li>
            <li class="flex my-2 text-xl text-creavidsTeal font-bold"><a class="flex" href="/services.html"><img src="./Assets/footer/Service.svg" class="mr-4 -mt-2 -ml-3 w-8 h-10" alt=""> Service</a></li>
          </ul>
        </div>
        <div class="w-1/4 pt-20 mt-2 pl-8 justify-center">
          <ul>
            <li class="flex my-2 text-xl text-creavidsTeal font-bold"><a class="flex" href="/"><img src="./Assets/footer/Agencies.svg" class="mt-2 mr-4 w-6 h-6" alt=""> Agencies</a></li>
            <li class="flex my-2 text-xl text-creavidsTeal font-bold"><a class="flex" href="/"><img src="./Assets/footer/Learn.svg" class="mt-2 mr-4 w-6 h-6" alt="">Learn</a></li>
            <li class="flex my-2 text-xl text-creavidsTeal font-bold"><a class="flex" href="/faq.html"><img src="./Assets/footer/FAQ.svg" class="mt-2 mr-4 w-6 h-6" alt="">FAQ</a></li>
            <li class="flex my-2 text-xl text-creavidsTeal font-bold"><a class="flex" href="/blog.html"><img src="./Assets/footer/Learn.svg" class="mt-2 mr-4 w-6 h-6" alt="">Blog</a></li>
          </ul>
        </div>
      </div>
      <div class="flex flex-wrap w-1/2">
