...
<body class="antialiased bg-grey-200  overflow-x-hidden mx-auto">
	<main class="lg:pt-20">
		...
		<div class="w-full md:w-3/5 mx-auto p-8 mb-16 questions">

			<div class="shadow-md text-creavidsDarkGray">
				<div class="tab w-full overflow-hidden border-t">
					<input class="absolute opacity-0" id="tab-single-one" type="radio" name="tabs2">
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-one">WHY SHOULD I OPT FOR A VIDEO ADVERTISEMENT?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
				...
				<div class="tab w-full overflow-hidden border-t">
					...
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-two">DOES CREAVIDS OFFER A COMPLETE VIDEO SOLUTION?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
				...
				<div class="tab w-full overflow-hidden border-t">
					...
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-three">WHY IS CREAVIDS THE BEST CHOICE FOR VIDEO PRODUCTION?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
						<p class="p-5">Creavids is a team of storytellers, animators, illustrators, directors, and
							...
							best way possible. We’re simply the best at connecting with you as well as your
				...
				<div class="tab w-full overflow-hidden border-t">
					...
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-four">ARE THERE ANY HIDDEN COSTS IN VIDEO PRODUCTION?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
				...
				<div class="tab w-full overflow-hidden border-t">
					...
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-five">IS THERE ANY REFUND POLICY IN PLACE?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
				...
				<div class="tab w-full overflow-hidden border-t">
					...
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-six">WHAT IS THE TYPICAL TIMEFRAME TO PRODUCE A VIDEO FROM SCRATCH?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
				...
				<div class="tab w-full overflow-hidden border-t">
					...
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-seven">WHAT IS THE ON BOARDING PROCESS?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
						<p class="p-5">In Video Production on boarding is done in 3 simple steps – Knowledge Transfer,
				...
				<div class="tab w-full overflow-hidden border-t">
					...
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-eight">HOW IS COMMUNICATION AND PROJECT MANAGEMENT DONE?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
				...
				<div class="tab w-full overflow-hidden border-t">
					...
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-nine">WHAT IS THE PROCESS FOR PRODUCING A VIDEO?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
				...
				<div class="tab w-full overflow-hidden border-t">
					<input class="absolute opacity-0" id="tab-single-ten" type="radio" name="tabs2">
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-ten">ARE THERE ANY LIMITS FOR THE NUMBER OF ITERATIONS?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
				...
				<div class="tab w-full overflow-hidden border-t">
					...
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-eleven">HOW DOES CREAVIDS MAKE SURE THE ASSETS DEVELOPED ARE IN LINE WITH CLIENT’S
						VISION?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
				...
				<div class="tab w-full overflow-hidden border-t">
					...
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-twelve">WHY ARE EXPLAINER VIDEOS A PREMIUM SERVICE?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
						<p class="p-5">Unlike most offerings in the market, explainer videos are created entirely from
							scratch. We don’t reuse old ideas or designs like many competitors do, nor do we
							...
							you’ll see what we mean 🙂</p>
					</div>
				</div>
				<div class="tab w-full overflow-hidden border-t">
					<input class="absolute opacity-0" id="tab-single-thirteen" type="radio" name="tabs2">
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-thirteen">IS THERE AN OPTION TO PRODUCE VIDEOS IN MULTIPLE LANGUAGES?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
				...
				<div class="tab w-full overflow-hidden border-t">
					...
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-fourteen">ARE THE VISUAL ASSETS CREATED BY CREAVIDS ORIGINAL?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
				...
				<div class="tab w-full overflow-hidden border-t">
					<input class="absolute opacity-0" id="tab-single-fifthteen" type="radio" name="tabs2">
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-fifthteen">WHAT IS THE FORMAT IN WHICH THE FINAL VIDEO IS DELIVERED?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
				...
				<div class="tab w-full overflow-hidden border-t">
					...
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-sixteen">CAN THE CLIENT REQUEST FOR PROJECT FILES UPON COMPLETION OF THE PROJECT?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
				...
				<div class="tab w-full overflow-hidden border-t">
					...
					<label class="block p-5 leading-normal cursor-pointer" for="tab-single-seventeen">DOES THE CLIENT NEED TO PAY ANY ROYALTY FEES TO USE THE VIDEO AND ITS ASSETS?</label>
					<div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-creavidsTeal leading-normal">
